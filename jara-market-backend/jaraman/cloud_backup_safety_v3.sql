...
CREATE TABLE `addresses` (
  ...
  KEY `addresses_lga_id_foreign` (`lga_id`),
  CONSTRAINT `addresses_country_id_foreign` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`) ON DELETE CASCADE,
  CONSTRAINT `addresses_lga_id_foreign` FOREIGN KEY (`lga_id`) REFERENCES `lgas` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `admin_permissions` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `admin_permissions_admin_id_foreign` (`admin_id`),
