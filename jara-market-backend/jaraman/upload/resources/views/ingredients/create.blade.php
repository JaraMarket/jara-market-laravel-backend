...
<div class="min-h-screen bg-slate-50">
        ...
        <div class="w-full px-6 lg:px-8 xl:px-10 py-4 flex items-center justify-between">
            <div>
                <div class="flex items-center gap-1.5 text-xs text-slate-400 mb-0.5">
                    ...
                    <span class="text-slate-600 font-medium">New Ingredient</span>
                </div>
                <h1 class="text-xl font-bold text-slate-900">Add New Ingredient</h1>
            </div>
    ...
    <div class="w-full px-6 lg:px-8 xl:px-10 py-6">
        ...
        <form action="{{ route('ingredients.store') }}" method="POST" enctype="multipart/form-data" id="ingredient-form">
            @csrf

            {{-- 2-column layout: left (8), right sidebar (4) --}}
            <div class="grid grid-cols-1 xl:grid-cols-12 gap-6">
                ...
                <div class="xl:col-span-8 space-y-5">
                    ...
                    <div class="bg-white rounded-xl border border-slate-200 overflow-hidden mt-5">
                        ...
                        <div class="p-6">
                            <div id="lga-prices-container" class="space-y-3"></div>
                            <div id="lga-prices-empty" class="flex flex-col items-center justify-center py-10 text-center">
                                <div class="w-14 h-14 rounded-full bg-slate-100 flex items-center justify-center mb-3">
                                    <svg class="w-7 h-7 text-slate-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                        ...
                        <div class="p-5 space-y-4">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="price" id="default_price" value="{{ old('price') }}"
                    ...
                    <div class="bg-white rounded-xl border border-slate-200 overflow-hidden">
                        <div class="px-5 py-4 border-b border-slate-100 bg-slate-50/60 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-400">Opening stock quantity</p>
                            </div>
                        </div>
                        <div class="p-5">
                            <div>
